...
<div class="container">
  ...
  <p class="center-align font-size-20"> Justificatif en attente de vérification </p>
  <div class="row">
    <div class="col s10 m10 offset-m1">
      <p class="center-align">Le document que vous avez transmis doit être validé avant la finalisation de votre inscription.
        Son statut sera mis à jour une fois qu'il aura été vérifié.
      </p>
    </div>
  </div>
    ...
    <div class="col s6 m6 offset-m3">
      <div class="card">
        ...
        <div class="card-image">
          <img class="materialboxed" src="../ressources/img/<?= $data['filename'] ?>">
        </div>
  ...
  <?php }else{ ?>
  <p class="center-align font-size-20"> Vos demandes d'inscription aux cours </p>
